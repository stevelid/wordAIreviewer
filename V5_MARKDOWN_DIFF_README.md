...
- `{MERGED->...}` tokens represent covered merged slots and should not be edited directly.
...
- Do not edit `{MERGED->...}` marker text directly; edit the referenced anchor cell ID.
